...
const sendPaymentConfirmationEmail = payment => {
    transporter.sendMail({
        from: "dasojib49@gmail.com", // verified sender email
        to: "dasojib49@gmail.com", // recipient email
...
async function run() {
    try {
        ...
        /*
        0.do not show the links those who should not see the links
